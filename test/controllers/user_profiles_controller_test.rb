...
class UserProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post user_profiles_url, params: { user_profile: { email: @user_profile.email, firstName: @user_profile.firstName, handphone: @user_profile.handphone, lastName: @user_profile.lastName, password: @user_profile.password } }
    end
  ...
  test "should update user_profile" do
    patch user_profile_url(@user_profile), params: { user_profile: { email: @user_profile.email, firstName: @user_profile.firstName, handphone: @user_profile.handphone, lastName: @user_profile.lastName, password: @user_profile.password } }
